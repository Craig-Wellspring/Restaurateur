...
public class HeatMapBoolVisual : MonoBehaviour
{
    ...
    public void SetGrid(GridSector<bool> grid) {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, GridSector<bool>.OnGridValueChangedEventArgs e) {
        updateMesh = true;
    }
