...
public class HeatMapGenericVisual : MonoBehaviour
{
    ...
    public void SetGrid(GridSector<HeatMapGridObject> grid) {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, GridSector<HeatMapGridObject>.OnGridValueChangedEventArgs e) {
        updateMesh = true;
    }
